## Карта мира
> _Версия карты: 0.2.3_  
  Текущие проблемы карты: надо выровнять названия стран, а также нарисовать острова (пока что это проблема в такой наклонённой версии) Трабхи и архипелаг Огненные Клыки.
